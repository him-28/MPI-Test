...
int main(int argc, char **argv)
{
    ...
    MPI_Comm shmcomm;
    MPI_Comm_split_type(MPI_COMM_WORLD, MPI_COMM_TYPE_SHARED /* FILLME */, 0, MPI_INFO_NULL, &shmcomm);
    ...
    MPI_Win_shared_query(win, south, &sz, &dsp_unit, &southptr/* FILLME */);
    MPI_Win_shared_query(/* FILLME */win, east, &sz, &dsp_unit, &eastptr);
    MPI_Win_shared_query(/* FILLME */win, west, &sz, &dsp_unit, &westptr);
